        ...
        is ExpensesUiState.Success -> {
            ...
            if (uiState.expenses.isEmpty()) {
                ...
                LazyColumn(
                    ...
                    //Vid 69,items = uiState.expenses, key = { it.id }
...
@OptIn(ExperimentalFoundationApi::class)
@Composable
//Vid 30 ,(onExpenseClick: (expense : Expense) -> Unit)
//Vid 33 ,uiState: ExpensesUiState
    ...
    LazyColumn(
        ...
        stickyHeader {
            Column(modifier = Modifier.background(colors.backgroundColor)){
                //Composable
                //Vid 28
                //vid 32,uiState.total
                ExpensesTotalHeader(uiState.total)
                AllExpensesHeader()
            }
        }
        //Vid 30
        //Vid 33, uiState.expenses
